...
describe('Wiki Storage', () => {
  ...
  describe('getWikiDir', () => {
    it('should return .rcs/wiki path', () => {
      const dir = getWikiDir(tempDir);
      expect(dir).toBe(path.join(tempDir, '.rcs', 'wiki'));
    });
  });
