export type CatalogSkillCategory = 'execution' | 'planning' | 'design' | 'shortcut' | 'utility';
...
const SKILL_CATEGORIES = new Set<CatalogSkillCategory>(['execution', 'planning', 'design', 'shortcut', 'utility']);
...
const REQUIRED_CORE_SKILLS = new Set(['blueprint', 'team', 'forge', 'ultrawork', 'autopilot']);
