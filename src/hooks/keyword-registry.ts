...
export const KEYWORD_TRIGGER_DEFINITIONS: readonly KeywordTriggerDefinition[] = [
  { keyword: '$forge', skill: 'forge', priority: 10, guidance: 'Activate the canonical forge completion loop with verification' },
  ...
  { keyword: "don't stop", skill: 'forge', priority: 9, guidance: 'Activate the canonical forge completion loop with verification' },
  { keyword: 'must complete', skill: 'forge', priority: 9, guidance: 'Activate the canonical forge completion loop with verification' },
  { keyword: 'keep going', skill: 'forge', priority: 9, guidance: 'Activate the canonical forge completion loop with verification' },

  { keyword: '$autopilot', skill: 'autopilot', priority: 10, guidance: 'Activate autopilot skill for autonomous execution' },
  { keyword: '$autoforge', skill: 'autoforge', priority: 10, guidance: 'Activate the canonical autoforge creator workflow' },
  ...
  { keyword: '$brief', skill: 'brief', priority: 9, guidance: 'Activate the canonical creator briefing workflow' },
  ...
  { keyword: '$blueprint', skill: 'blueprint', priority: 11, guidance: 'Activate the canonical blueprint consensus-planning workflow' },
  ...
  { keyword: 'consensus plan', skill: 'blueprint', priority: 11, guidance: 'Activate the canonical blueprint consensus-planning workflow' },
  ...
  { keyword: '$crew', skill: 'crew', priority: 9, guidance: 'Activate the canonical crew coordination workflow' },
