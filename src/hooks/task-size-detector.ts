 ...
 * (mandatory enforcement). In RCS, Codex CLI does not support pre-tool hooks, so this
 * module serves as:
 ...
 *
 * The actual gate enforcement in RCS is advisory: AGENTS.md instructs the model to
