...
For project-bound implementation, copy the approved reference into the workspace, for example under `.rcs/artifacts/visual-ralph/<slug>/reference.png`. Never leave the implementation reference only in `$CODEX_HOME/generated_images/...`.
