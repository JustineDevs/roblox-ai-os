---
name: autopilot
description: "[RCS] Strict autonomous loop: $ralplan -> $ralph -> $code-review"
---
...
- Use existing hooks, `.rcs/state`, `$ralplan`, `$ralph`, `$code-review`, and pipeline primitives; do not invent a separate execution framework.
