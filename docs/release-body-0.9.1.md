# roblox-ai-os-creator-skills v0.9.1

<p align="center">
  <img src="https://raw.githubusercontent.com/Yeachan-Heo/roblox-ai-os-creator-skills/v0.9.1/docs/shared/rcs-character-spark-initiative.jpg" alt="RCS character sparked for the Spark Initiative" width="720">
</p>
...
- The required packed-install smoke hydration fix landed later on `dev` in PR [#806](https://github.com/Yeachan-Heo/roblox-ai-os-creator-skills/pull/806).
